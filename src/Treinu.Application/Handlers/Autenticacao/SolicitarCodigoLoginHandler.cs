...
public class SolicitarCodigoLoginHandler : IRequestHandler<SolicitarCodigoLoginCommand, Result<object>>
{
    ...
    public async Task<Result<object>> Handle(SolicitarCodigoLoginCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var subject = "Código de Login - Treinu";
            var body = $@"
            <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;'>
                ...
                <div style='padding: 30px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px;'>
                    <h2 style='color: #0f172a; margin-top: 0;'>Acesso à sua conta</h2>
                    <p style='font-size: 16px; line-height: 1.5;'>Olá,</p>
                    <p style='font-size: 16px; line-height: 1.5;'>Aqui está o seu código de acesso ao <strong>Treinu App</strong>. Digite o código de 6 dígitos abaixo no aplicativo para realizar seu login imediatamente:</p>
                    ...
                    <p style='font-size: 14px; color: #64748b; line-height: 1.5;'>Este código é válido por <strong>15 minutos</strong>. Caso você não tenha tentado acessar sua conta, basta ignorar este e-mail.</p>
                </div>
