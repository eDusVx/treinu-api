...
namespace Treinu.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260616212141_AddTreinoDivisoesSchedule")]
    partial class AddTreinoDivisoesSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.AvaliacaoPlataforma", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AvaliacoesPlataforma", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.Chat.MensagemChat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SalaChatId");

                    b.ToTable("MensagensChat", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.Chat.ParticipanteSala", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MensagensNaoLidas")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("ParticipantesSala", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.Chat.SalaChat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SalasChat", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.ConfiguracaoNotificacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AlertaNovoTreino")
                        .HasColumnType("boolean");

                    b.Property<bool>("AlertaVencimentoAvaliacao")
                        .HasColumnType("boolean");

                    b.Property<bool>("AlertaVencimentoTreino")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.EventoTelemetria", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EventosTelemetria", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.ExecucaoExercicio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ExecucoesExercicio", (string)null);
                });

            modelBuilder.Entity("Treinu.Domain.Entities.ExecucaoTreino", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.Meta", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.Sugestao", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.Treino", b =>
                {
                    ...
                    b.Property<string>("DivisaoDomingo")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoQuarta")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoQuinta")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoSabado")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoSegunda")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoSexta")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");

                    b.Property<string>("DivisaoTerca")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");
                    ...
                    b.Property<string>("NomeDivisaoA")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("NomeDivisaoB")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("NomeDivisaoC")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("NomeDivisaoD")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.Chat.MensagemChat", b =>
                {
                    b.HasOne("Treinu.Domain.Entities.Usuario", "Remetente")
                        .WithMany()
                        .HasForeignKey("RemetenteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Treinu.Domain.Entities.Chat.SalaChat", "Sala")
                        .WithMany("Mensagens")
                        .HasForeignKey("SalaChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.ConfiguracaoNotificacao", b =>
                {
                    b.HasOne("Treinu.Domain.Entities.Usuario", null)
                        .WithOne()
                        .HasForeignKey("Treinu.Domain.Entities.ConfiguracaoNotificacao", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Treinu.Domain.Entities.ExecucaoExercicio", b =>
                {
                    b.HasOne("Treinu.Domain.Entities.ExecucaoTreino", null)
                        .WithMany("Exercicios")
